...
router.post('/', (0, auth_1.default)(auth_constants_1.USER_ROLE.ADMIN), marketingProfile_controller_1.MarketingProfileController.createMarketingProfile);
...
router.put('/:id', (0, auth_1.default)(auth_constants_1.USER_ROLE.ADMIN), marketingProfile_controller_1.MarketingProfileController.updateMarketingProfile);

...
router.post('/', (0, auth_1.default)(auth_constants_1.USER_ROLE.ADMIN, auth_constants_1.USER_ROLE.MANAGEMENT), projectResource_controller_1.ProjectResourceController.createProjectResource);
...
router.put('/:id', (0, auth_1.default)(auth_constants_1.USER_ROLE.ADMIN, auth_constants_1.USER_ROLE.MANAGEMENT), projectResource_controller_1.ProjectResourceController.updateProjectResource);

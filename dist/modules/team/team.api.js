...
team_controllers_1.TeamController.createTeam);
...
router.get('/lead/:teamLeadId', (0, auth_1.default)(auth_constants_1.USER_ROLE.ADMIN, auth_constants_1.USER_ROLE.MANAGER), team_controllers_1.TeamController.getTeamsByTeamLead);
// ✅ Update a team using slug
router.put('/:slug', (0, auth_1.default)(auth_constants_1.USER_ROLE.ADMIN, auth_constants_1.USER_ROLE.MANAGER), team_controllers_1.TeamController.updateTeam);
